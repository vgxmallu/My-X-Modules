...
from mbot.utils.helper.ai import stableDiffusion, deepaiImg, deepaiLogo, dreamShaper, stableDiffusionIn
...
@Client.on_message(filters.command(["deepai", "deep"]))
...
@Client.on_message(filters.command(["logo", "lo"]))
