...
@Mbot.on_message((filters.private | filters.group) & filters.command('connect'))
...
@Mbot.on_message((filters.private | filters.group) & filters.command('disconnect'))
...
@Mbot.on_message(filters.private & filters.command(["connections"]))
